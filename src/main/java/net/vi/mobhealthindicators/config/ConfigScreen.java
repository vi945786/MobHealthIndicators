...
public class ConfigScreen {
    ...
    public static Screen getConfigScreen(Screen parent) {
        ...
        ConfigCategory display = configBuilder.getOrCreateCategory(Text.translatable("config.mobhealthindicators.category.display"));
            ...
            display.addEntry(entryBuilder.startBooleanToggle(Text.translatable("config.mobhealthindicators.option.dynamicbrightness"), config.dynamicBrightness).setDefaultValue(Config.dynamicBrightnessDefault).setSaveConsumer(value -> config.dynamicBrightness=value).setTooltip(Text.translatable("config.mobhealthindicators.option.dynamicbrightness.tooltip")).build());
            ...
            display.addEntry(entryBuilder.startBooleanToggle(Text.translatable("config.mobhealthindicators.option.renderontoponhover"), config.renderOnTopOnHover).setDefaultValue(Config.renderOnTopOnHoverDefault).setSaveConsumer(value -> config.renderOnTopOnHover=value).setTooltip(Text.translatable("config.mobhealthindicators.option.renderontoponhover.tooltip")).build());
